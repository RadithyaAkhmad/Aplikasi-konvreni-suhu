...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (isRunning)
        {
            ...
            {
                case "1":
                    Console.Write("Masukkan suhu dalam satuan Celcius yaa: ");
                ...
                case "3":
                    Console.Write("Masukkan suhu dalam satuan Celcius rek: ");
                    celcius = Convert.ToDouble(Console.ReadLine());
                ...
                case "4":
                    ...
                    Console.WriteLine("Terima kasih telah percaya dengan saya secara sepenuh jiwa :D.");
                    break;

                default:
                    Console.WriteLine("Pilihan tidak ada. Silakan coba lagi mungkin ada yang salah sama beliau.");
                    break;
            }
            ...
            if (isRunning)
            {
                ...
                Console.WriteLine("lhaa,ngerti? btw jangan lupa mbalik tapi jangan balikan sama dia nanti sakitnya terulang lagi.");
                Console.ReadKey();
            }
        }
    }
